            ...
            <Col xs={12} className="d-flex align-items-center justify-content-center">
              <div className="mb-4 mb-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                <div className="text-center text-md-center mb-4 mt-md-0">
                  <h3 className="mb-0">Criar uma conta</h3>
                </div>
                <Form className="mt-4">
                  ...
                  <Form.Group id="confirmPassword" className="mb-4">
                    <Form.Label>Confirme a Palavra de Acesso</Form.Label>
                    <InputGroup>
                      <InputGroup.Text>
                        <FontAwesomeIcon icon={faUnlockAlt} />
                      </InputGroup.Text>
                      <Form.Control required type="password" placeholder="Confirme a Palavra de Acesso" />
                    </InputGroup>
                  </Form.Group>
                  <FormCheck type="checkbox" className="d-flex mb-4">
                    <FormCheck.Input required id="terms" className="me-2" />
                    <FormCheck.Label htmlFor="terms">
                      Eu aceito os <Card.Link>termos and condições</Card.Link>
                    </FormCheck.Label>
                  </FormCheck>
